        ...
        <section className="home-setion">
          ...
          <div>
            ...
            <div className='home-left'>
                <img className='header-img' src="./images/slide1.png" alt="" />
              </div>
              <div className='home-right'>
              <h1 className='home-title'>Everything you need for your digital world</h1>
             ...
             <div className='contact-btn-home'>
                <a className='contact-link-home' href="#">Contact Us</a>
                <svg className='contact-arrow-icon-home' width="18" height="14" viewBox="0 0 29 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='home-flex'>
              <div className='home-left'>
              <img className='header-img' src="./images/slide2.png" alt="" />
              </div>
