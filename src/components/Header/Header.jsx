...
const Header = ({scroll,Homes,Service,Pro,Team}) => {
    ...
    return (
        <nav className='navbar'>
            ...
            <div className={openMenu === true ?'menu-mobile':'menu'}>
                <Link className={openMenu === true ?'menu-link-mobile':'menu-link'} to="/" onClick={Homes}>Home</Link>
                <Link className={openMenu === true ?'menu-link-mobile':'menu-link'} to="/portfolio"  onClick={Service}>Services</Link>
                <Link className={openMenu === true ?'menu-link-mobile':'menu-link'} to="/portfolio" onClick={scroll}>Method</Link>
                <Link className={openMenu === true ?'menu-link-mobile':'menu-link'} to="/portfolio"  onClick={Pro}>Portfolio</Link>
                <Link className={openMenu === true ?'menu-link-mobile':'menu-link' } to='/ourTeam'  onClick={Team}>Our Team</Link>
            </div>
